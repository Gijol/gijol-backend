...
public enum ChemistryMajor {
    ...
    FROM2018(List.of(18), 36, List.of(CH3102, CH3103, CH3104, CH3105, CH3106)),
    FROM2019(List.of(19, 20, 21), 36, List.of(CH2101, CH2102, CH2103, CH2104, CH2105, CH3106, CH3107));
